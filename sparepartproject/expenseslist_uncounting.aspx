<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="expenseslist_uncounting.aspx.cs" Inherits="sparepartproject.expenseslist_uncounting" %>
...
<head runat="server">
    ...
    <meta charset="utf-8" />
    <title>Sparepart Inventory - Expenses List Uncounting</title>
    <!-- Bootstrap CSS CDN -->
...
<body>
        ...
        <div id="content">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <div class="container-fluid">
                    ...
                    <h5 style="margin-bottom: 0px; margin-left: 20px;">Expenses (Uncounting)</h5>
            ...
            <form id="form1" runat="server">
                ...
                <div class="col-lg-12 col-sm-12 col-xl-12 col-12 col-xs-12" style="margin-left: 0;">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <label style="margin-top: 0px; font-size: 1.5rem;" class="mb-3">List Expenses Data (Uncounting Part)</label>
                    ...
                    <div class="modal-dialog modal-xl">
                        <div class="modal-content">
                                ...
                                <div class="container">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xl-4">
                                            ...
                                            <div class="col-lg-12">
                                                <asp:TextBox CssClass="form-control" TextMode="Number" ID="txtQty" Enabled="true" AutoPostBack="true" runat="server" Width="65%"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xl-4">
                                            <div class="col-lg-2">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xl-3">
                                            ...
                                            <div class="col-lg-12">
                                                <asp:TextBox CssClass="form-control" ID="txtUnitPrice" OnTextChanged="txtUnitPrice_TextChanged" Text="0" TextMode="Number" AutoPostBack="true" Enabled="true" runat="server" Width="70%"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xl-3">
                                            <div class="col-lg-2">
                            ...
                            <div class="modal-footer">
                                ...
                                <asp:LinkButton ID="btnSave" OnClientClick="return cekKosong();" Text="Update Order" OnClick="btnSave_Click" CssClass="btn btn-outline-primary text-center" runat="server"></asp:LinkButton>
                ...
                <div class="modal fade" id="myComingCancel">
                    <div class="modal-dialog modal-xl">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title" id="lbltitle">FORM CANCEL ORDER</h4>
                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                            </div>
                            <div class="modal-body">
                                <div class="container">
                            ...
                            <!-- Modal footer -->
                            <div class="modal-footer">
                                <asp:LinkButton ID="btnCancelOrder_ComingCancel" Text="Cancel Order" OnClientClick="return ConfirmCancel_ComingCancel();" CssClass="btn btn-outline-dark text-center" runat="server"></asp:LinkButton>
                                <button type="button" class="btn btn-outline-danger text-center" data-dismiss="modal">Close Form</button>
                                <%--<button type="button" class="btn btn-outline-primary text-center text-center" onclick="ConfirmComing();">Complete Order</button>--%>
                            </div>
                    ...
                    <div class="modal-dialog modal-xl">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-outline-danger text-center" data-dismiss="modal">Close</button>
                                <%--<asp:Button ID="btnInsertDataOnebyOne" runat="server" CssClass="btn btn-outline-primary text-center" Text="Insert Data" OnClick="btnInsertDataOnebyOne_Click" />--%>
                                <asp:LinkButton ID="LinkButton2" Text="Update" CssClass="btn btn-outline-primary text-center" runat="server"></asp:LinkButton>
    ...
    <script type="text/javascript">
        ...
        function ConfirmComing() {
            var confirm_value = document.createElement("INPUT");
            confirm_value.type = "hidden";
            confirm_value.name = "confirm_value";
            var ID = document.getElementById('hdExpID_ComingCancel').value;
            var partName = document.getElementById('hdPartName_ComingCancel').value;
            var partCode = document.getElementById('hdPartCode_ComingCancel').value;

            if (ID == "") {
                alert("Data not complete, please try again.");
                return false;
            } else {
                if (confirm("Confirm Part Coming dengan ID " + ID + ", Part Name " + partName + ", dan Part Code " + partCode + " ? ")) {
                    confirm_value.value = "Yes";

                    //$('#UpdateProgress').show();

                    var modelForOriginalModel = document.getElementById('ddlModel_ComingCancel').value;
        ...
        $(document).ready(function () {
            ...
            $('#loadingImg').show();
            $.ajax({
                url: "/expenseslist_uncounting.aspx/getAllNewExpenses",
                method: 'post',
                contentType: "application/json; charset=utf-8",
            ...
            $.ajax({
                url: "/expenseslist_uncounting.aspx/getAllNewExpenses_Oversea",
                method: 'post',
                contentType: "application/json; charset=utf-8",
                success: function (data) {
                    var json = JSON.parse(data.d);
            ...
            $.ajax({
                url: "/expenseslist_uncounting.aspx/getAllNewExpenses_Cancel",
                method: 'post',
                contentType: "application/json; charset=utf-8",
                success: function (data) {
                    var json = JSON.parse(data.d);
            ...
            $.ajax({
                url: "/expenseslist_uncounting.aspx/getAllNewExpenses_Coming",
                method: 'post',
                contentType: "application/json; charset=utf-8",
                success: function (data) {
                    var json = JSON.parse(data.d);
        ...
        $('#tblNew').on('click', 'tr', function () {
            ...
            var getRemarks = $('td', this).eq(26).text();;
        ...
        $('#tblComing').on('click', 'tr', function () {
            ...
            var getPICOrder = $('td', this).eq(25).text();
            var getModel = $('td', this).eq(27).text();
            var getPurpose = $('td', this).eq(25).text();
            var getUnit = $('td', this).eq(6).text();
            var getQuotNo = $('td', this).eq(15).text();
            var getPrice = $('td', this).eq(9).text();
            var getAmount = $('td', this).eq(10).text();
            ...
            var getPRno = $('td', this).eq(17).text();
            var getPOno = $('td', this).eq(19).text();
            var getRemark = $('td', this).eq(26).text();
            getExpID = getExpID.replace(/\s/g, '');
            getModel = getModel.replace(/\s/g, '');
            getUnit = getUnit.replace(/\s/g, '');
            getQuotNo = getQuotNo.replace(/\s/g, '');
            ...
            document.getElementById('lbltitle').innerHTML = 'PART COMING';
            ...
            document.getElementById('txtRemark_ComingCancel').value = getRemark;
